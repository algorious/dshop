...
class Item(models.Model):
    ...
    label_text = models.CharField(
        choices=LABEL_TEXT_CHOICES, max_length=1, blank=True, null=True)
...
class Order(models.Model):
    ...
    items = models.ManyToManyField(OrderItem, through='OrderItems')
...
class Address(models.Model):
    ...
    # default address for further purchaces
